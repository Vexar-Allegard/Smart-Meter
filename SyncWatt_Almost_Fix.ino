...
#define BLYNK_TEMPLATE_ID "TMPL66Avzy0Y0"
#define BLYNK_TEMPLATE_NAME "Smart Meter"
#define BLYNK_AUTH_TOKEN "uTQ5n6zf9VZvyLaCu7pLEoVYQPDuzrWa"
...
char ssid[] = "MISKIN BANGET LUU"; // WiFi Name
char pass[] = "UwUHahaY1"; // WiFi Password
...
void setup() {
  ...
  setupDisplay();
  pinMode(13,OUTPUT);
  Blynk.begin(BLYNK_AUTH_TOKEN, ssid, pass); // Change the Blynk Server and Port Number when required.
}
